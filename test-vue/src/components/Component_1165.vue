<template>
  <div class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
      <h1 class="text-4xl font-bold text-center mb-8">Welcome to Our Education Institution</h1>
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
          <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <img class="w-full" src="https://static.photos/education/900x600/167.webp" alt="Campus">
            <div class="p-4">
              <h2 class="text-xl font-bold mb-2">Our Campus</h2>
