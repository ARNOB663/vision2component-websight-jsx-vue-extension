<template>
  <header class="sticky top-0 bg-white shadow-md">
    <div class="container mx-auto p-4">
      <h1 class="text-2xl font-bold">Marketing Agency</h1>
    </div>
  </header>
  ...
  <main class="container mx-auto p-4">
    <div class="flex flex-col md:flex-row">
      <div class="w-full md:w-1/2 p-4">
        <img src="https://picsum.photos/seed/59/900/600" alt="Team Image" class="w-full">
      </div>
      <div class="w-full md:w-1/2 p-4">
        <p class="text-lg">
  ...
  <footer class="bg-gray-800 text-white p-4">
    <div class="container mx-auto">
      <p class="text-center">
        &copy; 2022 Marketing Agency. All rights reserved.
      </p>
    </div>
  </footer>
</template>
