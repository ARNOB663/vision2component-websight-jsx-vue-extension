  ...
  <header class="bg-indigo-500 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
      <div class="flex items-center">
        <img src="https://static.photos/art/300x300/38.webp" alt="Bank Logo" class="h-10">
        <h1 class="ml-4 text-2xl">Banking Institution</h1>
      </div>
      <nav>
        <ul class="flex">
          <li class="mr-4"><a href="#" class="hover:underline">Home</a></li>
          <li class="mr-4"><a href="#" class="hover:underline">About</a></li>
          <li class="mr-4"><a href="#" class="hover:underline">Services</a></li>
