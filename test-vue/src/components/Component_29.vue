<template>
  <div class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover bg-center" :style="{ backgroundImage: 'url(https://picsum.photos/seed/29/1600/900)' }">
    ...
    <main class="max-w-4xl mx-auto p-4">
      ...
      <section id="insurance" class="my-8">
        <h2 class="text-2xl">Insurance Providers</h2>
