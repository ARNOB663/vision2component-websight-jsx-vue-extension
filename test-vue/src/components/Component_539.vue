  ...
  <div class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
      <header class="flex justify-between items-center">
        <h1 class="text-3xl font-bold">Travel Agency</h1>
        <nav>
          <ul class="flex space-x-4">
            <li><a href="#flights" class="text-pink-500 hover:text-pink-700">Flights</a></li>
            <li><a href="#hotels" class="text-pink-500 hover:text-pink-700">Hotels</a></li>
            <li><a href="#tours" class="text-pink-500 hover:text-pink-700">Tours</a></li>
            <li><a href="#packages" class="text-pink-500 hover:text-pink-700">Packages</a></li>
          </ul>
        </nav>
      </header>

      <main class="mt-8">
        <section id="flights" class="mb-8">
          <h2 class="text-2xl font-bold mb-4">Flights</h2>
