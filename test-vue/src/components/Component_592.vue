<template>
  <nav class="bg-purple-900 p-4">
    <ul class="flex space-x-4">
      ...
      <li><a href="#" class="hover:text-purple-300">Artists</a></li>
      <li><a href="#" class="hover:text-purple-300">Exhibitions</a></li>
      <li><a href="#" class="hover:text-purple-300">Contact</a></li>
    </ul>
  </nav>

  <main class="container mx-auto p-4">
    <h1 class="text-4xl mb-4">Welcome to our Art Gallery</h1>
    <p class="mb-4">
    ...
    <div class="grid grid-cols-3 gap-4">
      <img src="https://static.photos/art/900x600/194.webp" alt="Art Piece" class="rounded">
      <img src="https://static.photos/art/900x600/195.webp" alt="Art Piece" class="rounded">
      <img src="https://static.photos/art/900x600/196.webp" alt="Art Piece" class="rounded">
