<template>
  <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
    ...
    <div>
      <a href="#" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Donate</a>
    </div>
  </nav>

  <section class="bg-gray-200 py-20 px-4">
    <div class="max-w-xl mx-auto text-center">
      <img src="https://picsum.photos/seed/152/900/600" alt="Non-Profit Image" class="mb-4">
      <h1 class="text-3xl mb-4">Our Mission</h1>
      <p class="text-lg">
  ...
  <section class="py-20 px-4">
    <div class="max-w-xl mx-auto">
      <h2 class="text-3xl mb-4 text-center">Testimonials</h2>
      <div class="flex flex-wrap -mx-2">
        <div class="w-full md:w-1/2 px-2 mb-4">
          <div class="bg-white p-4 rounded">
            ...
            <p class="text-right mt-4">- John Doe</p>
          </div>
        </div>
  ...
  <section class="bg-gray-200 py-20 px-4">
    <div class="max-w-xl mx-auto text-center">
      <h2 class="text-3xl mb-4">Volunteer Opportunities</h2>
      <p class="text-lg">
