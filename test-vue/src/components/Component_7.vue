<template>
  <header class="bg-cover bg-center h-screen" :style="{ backgroundImage: 'url(https://picsum.photos/seed/7/1600/900)' }">
    <div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center h-full">
      <div class="w-full">
        <img src="https://picsum.photos/seed/7/300/300" alt="Logo" class="mx-auto">
