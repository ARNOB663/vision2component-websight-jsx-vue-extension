<template>
  <header class="bg-white shadow">
    <div class="container mx-auto flex flex-col p-5 md:flex-row items-center">
      <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
        <span class="ml-3 text-xl">Home Improvement Store</span>
      </a>
  ...
  <footer class="bg-white">
    <div class="container mx-auto px-5 py-6">
      <p class="text-sm text-gray-400">© 2022 Home Improvement Store. All rights reserved.</p>
    </div>
  </footer>
</template>
