<template>
  <div class="bg-gray-100">
    <header class="bg-white p-4 flex justify-between items-center">
      <img src="https://static.photos/people/300x300/123.webp" alt="Logo" class="h-10">
      <nav>
    ...
    <section class="flex p-4">
      <div class="w-1/2 p-4">
        <h1 class="text-3xl font-bold mb-4">Welcome to our Non-Profit Organization</h1>
        ...
        <img src="https://static.photos/people/900x600/124.webp" alt="People" class="mb-4">
      </div>
    ...
    <footer class="bg-white p-4 text-center">
      <p class="text-gray-600">
        &copy; 2022 Non-Profit Organization. All rights reserved.
      </p>
    </footer>
  </div>
</template>
