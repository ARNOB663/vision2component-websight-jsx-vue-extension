<template>
  <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
    <div class="flex items-center flex-shrink-0 text-white mr-6">
      <span class="font-semibold text-xl tracking-tight">Real Estate Agency</span>
    </div>
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      ...
      <form class="flex items-center">
        <input type="text" placeholder="Search..." class="bg-white rounded-full px-4 py-2 mr-2">
        <button type="submit" class="bg-white text-teal-500 rounded-full px-4 py-2">
          Search
        </button>
      </form>
    </div>
