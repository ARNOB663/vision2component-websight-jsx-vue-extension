<template>
  <header class="w-full h-96 bg-center bg-cover" :style="{ backgroundImage: `url('https://static.photos/business/1600x900/8.webp')` }"></header>
  ...
  <footer class="bg-navy-purple p-4">
