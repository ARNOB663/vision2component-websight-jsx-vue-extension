<template>
  <header class="bg-gray-800 text-white p-4">
    <h1 class="text-2xl">Architecture Firm</h1>
  </header>

  <section class="bg-gray-200 p-4">
    <h2 class="text-xl mb-4">Featured Projects</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div v-for="(project, index) in projects" :key="index">
        <img :src="'https://picsum.photos/seed/259/900/600'" :alt="project.title" class="mb-2">
  ...
  <section class="p-4">
    <h2 class="text-xl mb-4">About the Firm</h2>
...
const projects = [
  {
    image: 'https://picsum.photos/seed/259/900/600',
    title: 'Project 1',
    description: 'This is a beautiful example of an architecture project. The firm uses cutting-edge technology to create innovative designs that are both beautiful and functional.'
  },
