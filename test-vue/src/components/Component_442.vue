<template>
  <header class="w-full h-64 bg-cover bg-center" :style="{ backgroundImage: 'url(https://static.photos/technology/1600x900/43.webp)' }">
    <div class="container mx-auto px-6 py-3 flex justify-center">
      <img class="h-16" src="https://static.photos/technology/300x300/44.webp" alt="Logo">
    </div>
  </header>
  <nav class="bg-blue-500 text-white p-4">
    <div class="container mx-auto flex justify-center">
      <a href="#" class="px-2">Home</a>
      <a href="#" class="px-2">Products</a>
  ...
  <main class="container mx-auto px-6 py-3">
    <div class="flex flex-wrap -mx-2 overflow-hidden">
      <div class="my-2 px-2 w-full md:w-1/3">
        <h2 class="text-2xl">Product Showcase</h2>
